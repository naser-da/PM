...
@if($type == 'single')
    <div x-data="app('{{ $default_date }}', '{{ strtoupper($format) }}')" x-init="[initDate(), getNoOfDays()]" x-cloak>
        <div class="relative w-full">
            ...
            <div class="bg-gray dark:bg-dark-600 mt-12 p-4 absolute top-0 left-0 z-50 shadow-md rounded-lg"
                 style="width: 17rem"
                ...
                <div class="flex flex-wrap -mx-1">
                    ...
                    <template x-for="(date, dateIndex) in no_of_days" :key="dateIndex">
                        <div style="width: 14.28%" class=" mb-1">
                            ...
                            'text-gray-600 dark:text-gray-100 hover:bg-white-200 hover:dark:bg-dark-500': isToday(date) == false && isSelectedDate(date) == false,
