    ...
    <div class="w-full absolute z-50 bg-white -mt-1 shadow-md cursor-pointer dropdown-items-parent dark:text-dark-300 dark:border-dark-700 dark:bg-dark-800 hidden" style="max-height: 270px; overflow: scroll;">
        <div class="dropdown-items border border-gray-300 dark:border-dark-700 divide-y relative w-full">
            @if($searchable)
                <div class="bg-slate-50 dark:text-dark-300 dark:border-dark-700 dark:bg-dark-900 sticky top-0 min-w-full">
                    <x-bladewind::input
                        ...
                        add_clearing="false"
                        class="w-full bg-gray-900 border-0 focus:border-0"
            ...
            <div
                ...
                data-user-function=""
                data-parent="{{ $name }}"
                class="dd-item bg-gray-900 p-4 cursor-pointer default hidden">{{ $placeholder }}
            ...
            @for ($x=0; $x < count($data); $x++)
                ...
                @endphp
                <div
                    {{ $attributes->merge(['class' => "dd-item p-3 cursor-pointer hover:bg-gray-900 flex items-center dark:text-dark-300 dark:border-dark-700 dark:bg-dark-800 dark:hover:bg-dark-900 dark:hover:text-dark-300"]) }}
                    data-href="{{$url}}"
